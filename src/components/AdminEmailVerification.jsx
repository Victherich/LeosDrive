  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://www.leosdrive.com/api/admin_email_verification.php",
        { otp },
      ...
      if (response.data.success) {
        Swal.fire({ icon: "success", title: "Verified!", text: response.data.message }).then(() => {
          navigate("/adminlogin"); // Redirect to the dashboard after verification
        });
      } else {
  ...
  return (
    <Container>
      ...
      <FormWrapper>
        ...
        <TextLink onClick={() => navigate("/adminresendemailotp")}>Resend OTP</TextLink>
      </FormWrapper>
    </Container>
  );
};
