  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://www.leosdrive.com/api/driver_resend_email_otp.php",
        { email },
      ...
      if (response.data.success) {
        Swal.fire({ icon: "success", title: "OTP Sent!", text: response.data.message }).then(() => {
          navigate("/driveremailverification"); // Redirect to verification page
        });
      } else {
  ...
  return (
    <Container>
      ...
      <FormWrapper>
        ...
        <TextLink onClick={() => navigate("/driveremailverification")}>Go Back to Verify OTP</TextLink>
      </FormWrapper>
    </Container>
  );
};

export default DriverResendEmailOTP;
